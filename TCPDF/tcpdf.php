...
class TCPDF {
	 ...
	 */
	protected $default_monospaced_font = 'freesans';
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
		...
		$this->InFooter = false;
		$this->lasth = 0;
		$this->FontFamily = defined('PDF_FONT_NAME_MAIN')?PDF_FONT_NAME_MAIN:'freesans';
		$this->FontStyle = '';
		$this->FontSizePt = 12;
		...
		$this->CoreFonts = array(
			'freesans'=>'freesans',
			'freesansB'=>'freesans-Bold',
			'freesansI'=>'freesans-Oblique',
			'freesansBI'=>'freesans-BoldOblique',
			'helvetica'=>'Helvetica',
	...
	public function Close() {
		...
		if ($this->tcpdflink) {
			...
			$font = defined('PDF_FONT_NAME_MAIN')?PDF_FONT_NAME_MAIN:'freesans';
			$this->SetFont($font, '', 1);
	 ...
	 * @param $family (string) Family font. It can be either a name defined by AddFont() or one of the standard Type1 families (case insensitive):<ul><li>times (Times-Roman)</li><li>timesb (Times-Bold)</li><li>timesi (Times-Italic)</li><li>timesbi (Times-BoldItalic)</li><li>helvetica (Helvetica)</li><li>helveticab (Helvetica-Bold)</li><li>helveticai (Helvetica-Oblique)</li><li>helveticabi (Helvetica-BoldOblique)</li><li>freesans (freesans)</li><li>freesansb (freesans-Bold)</li><li>freesansi (freesans-Oblique)</li><li>freesansbi (freesans-BoldOblique)</li><li>symbol (Symbol)</li><li>zapfdingbats (ZapfDingbats)</li></ul> It is also possible to pass an empty string. In that case, the current family is retained.
	...
	protected function _putcatalog() {
		...
		if (!empty($this->form_obj_id)
			...
			$font = $this->getFontBuffer('freesans');
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	 ...
	 * @param $correct_align (boolean) if true correct the number alignment (numbers must be in monospaced font like freesans and right aligned on LTR, or left aligned on RTL)
	 * @param $style (string) Font style for title: B = Bold, I = Italic, BI = Bold + Italic.
